...
export default function PrimarySearchAppBar({updateMode}) {
      ...
      <AppBar position="fixed" sx={{bgcolor:theme.palette.background.paper,px:{sx:0,sm:20,lg:40}}} >
        <Toolbar>
          ...
          <IconButton size="large" aria-label="show 4 new mails" color="inherit" sx={{color:'lightslategray'}} component={NavLink} to="/jobs">
            ...
            <IconButton size="large" aria-label="show 4 new mails" color="inherit" sx={{color:'lightslategray'}} onClick={changeTheme}>
